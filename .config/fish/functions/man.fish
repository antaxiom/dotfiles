...
function man --wraps man -d "Run man with added colors"
    ...
    set -x LESS_TERMCAP_md (printf $bold_ansi_code$green_ansi_code) # start bold
    set -x LESS_TERMCAP_me (printf $reset_ansi_code) # end bold
    set -x LESS_TERMCAP_us (printf $underline_ansi_code$teal_ansi_code$bold_ansi_code) # start underline
    set -x LESS_TERMCAP_ue (printf $reset_ansi_code) # end underline
    set -x LESS_TERMCAP_so (printf $bold_ansi_code$gold_ansi_code) # start standout
