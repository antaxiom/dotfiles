...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#ff5555", "cterm": "204", "cterm16": "1" }),
      ...
      \ "white": get(s:overrides, "white", { "gui": "#CCCCCC", "cterm": "145", "cterm16": "7" }),
      ...
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#181818", "cterm": "237", "cterm16": "8" }),
